...
namespace Destruction_Derby
{
    ...
    public class DDGamemode : Script
    {
        public DDGamemode()
        {
            ...
            API.consoleOutput("Gamemode Destruction Derby inicializado!");
			API.consoleOutput("Se han cargado " + AvailableRaces.Count + " carreras.");
	...
	private void onServerResourceStartHandler(string resource)
	{
		...
		// Objects (Total: 3)
		//API.createObject(1673290408, new Vector3(-1849.5459, -1235.072, 12.0174532), new Vector3(89.21008, -0.5153011, -129.504639), 0);
		//API.createObject(1673290408, new Vector3(-1854.23914, -1240.80579, 12.1460781), new Vector3(89.2100754, -0.5153022, -129.504639), 0);
		//API.createObject(1673290408, new Vector3(-1850.168, -1230.32556, 12.0172729), new Vector3(-169.036942, -86.2519455, 179.999435), 0);
	}
        ...
        public void onUpdate()
        {
            ...
            lock (Opponents)
            {
                ...
                if (count <= 1)
                {
                    ...
                    else API.sendChatMessageToAll("No hay ganadores!");
        ...
        public void onChatCommand(Client sender, string message, CancelEventArgs cancel)
        {
            ...
            else if (message.StartsWith("/vote"))
            {
                ...
                {
                    API.sendChatMessageToPlayer(sender, "Actualmente no hay algún voto en progreso.");
                    return;
                }
                ...
                if (args.Length <= 1)
                {
                    API.sendChatMessageToPlayer(sender, "USE", "/vote [id]");
                    return;
                }
                ...
                Votes[choice]++;
                API.sendChatMessageToPlayer(sender, "Has votado por " + AvailableChoices[choice].Name);
                Voters.Add(sender);
                return;
            }
        }
